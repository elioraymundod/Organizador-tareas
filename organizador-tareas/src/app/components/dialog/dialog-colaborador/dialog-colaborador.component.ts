...
@Component({
  selector: 'app-dialog-colaborador',
  templateUrl: './dialog-colaborador.component.html',
  styleUrls: ['./dialog-colaborador.component.css']
})
export class DialogColaboradorComponent implements OnInit {
  ...
  constructor(
    ...
    private correosService: EnvioCorreoService,
  ...
  enviarCorreo(data: any) {
    const datosCorreo = {
      ...
      asuntoCorreo: 'Invitación a un Tablero',
      cuerpoCorreo: '',
      htmlCorreo: `
      ...
      <head>
        ...
        <title>Nueva plantilla de correo electrC3B3nico 2022-10-16</title><!--[if (mso 16)]>
          <style type="text/css">
            ...
            <table cellpadding="0" cellspacing="0" class="es-content" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%">
              <tr>
                ...
                <table bgcolor="#D8599E" class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#D8599E;border-right:4px solid #ffffff;border-left:4px solid #ffffff;width:600px">
                  <tr>
                    <td align="left" bgcolor="#a64d79" style="padding:0;Margin:0;padding-left:20px;padding-right:20px;padding-bottom:40px;background-color:#a64d79">
                    <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                      <tr>
                        <td align="center" valign="top" style="padding:0;Margin:0;width:552px">
                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                          <tr>
                            <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-top:30px"><h1 style="Margin:0;line-height:60px;mso-line-height-rule:exactly;font-family:Montserrat, helvetica, arial, sans-serif;font-size:50px;font-style:normal;font-weight:bold;color:#FFFFFF">Únete a nuestro tablero<br></h1></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:10px;padding-bottom:10px;padding-left:40px;padding-right:40px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'trebuchet ms', 'lucida grande', 'lucida sans unicode', 'lucida sans', tahoma, sans-serif;line-height:24px;color:#ffffff;font-size:16px">Te hemos invitado a formar parte del tablero "${this.columnasService.nombreTablero}", para poder unirte solo debes hacer click en el botón "UNIRME".</p></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                          <tr>
                            <td align="center" style="padding:0;Margin:0"><span class="es-button-border" style="border-style:solid;border-color:#FFFFFF;background:#741b47;border-width:3px;display:inline-block;border-radius:0px;width:auto"><a href="http://localhost:4200/tablero/${this.columnasService.codigoTablero}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;border-style:solid;border-color:#741b47;border-width:10px 30px 10px 30px;display:inline-block;background:#741b47;border-radius:0px;font-family:Montserrat, helvetica, arial, sans-serif;font-weight:bold;font-style:normal;line-height:22px;width:auto;text-align:center">UNIRME</a></span></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table></td>
    ...
    this.dialogRef.close();
    this.correosService.enviarCorreo(datosCorreo).subscribe(res => {
    ...
    const dataUserTablero = {
      USUARIO: data.correo,
      PROYECTO: this.columnasService.codigoTablero,
      USUARIO_CREACION: this.loginService.login,
      FECHA_CREACION: this.datePipe.transform(new Date(), 'yyyy-MM-dd HH:mm:ss'),
    }
    this.usuariosTablerosService.insertUsuarioTablero(dataUserTablero).subscribe(res => {
